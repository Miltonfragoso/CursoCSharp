...
using ExercDeFixacao.Services;
using System;
using System.Globalization;

namespace ExercDeFixacao
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime dataC = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy", CultureInfo.InvariantCulture);

            Console.Write("Valor do contrato: ");
            double valorTotalC = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);

            Console.WriteLine("Infomr o número de parcelas desejada: ");
            int numeroParcelas = int.Parse(Console.ReadLine());

            Contrato contrato = new Contrato(numeroC, dataC, valorTotalC);
