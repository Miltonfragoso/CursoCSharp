 ...
 * Vantagens: Organização, divizão de responsabilidades; Coesão, cada objeto é responsavel por uma única coisa; flexibilidade; Reuso
 * 
 * A composição também pode ocorrer com serviços
 */
